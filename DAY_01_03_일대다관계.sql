/*
    ...
    2. 외래키는 중복값을 가질 수 있고 NULL 값을 가질 수 있다.
    3. 참조 무결성을 가져야 한다.
...
CREATE TABLE ORDER_T (
    ...
    PRODUCT_NO NUMBER REFERENCES PRODUCT_T(PRODUCT_NO) ON DELETE CASCADE,
    ORDERED_AT DATE NOT NULL
);

INSERT INTO PRODUCT_T VALUES ( 1, '새우깡', 1000, 15);
INSERT INTO ORDER_T VALUES ( 1, 'ab***', 1, '2021/03/03');
DELETE FROM PRODUCT_T WHERE PRODUCT_NO = 1;

...
SELECT EMPLOYEE_ID, CEIL(MONTHS_BETWEEN(SYSDATE, HIRE_DATE))
FROM EMPLOYEES;
...
SELECT EMPLOYEE_ID, PHONE_NUMBER, CASE
...
SELECT EMPLOYEE_ID, CEIL(MONTHS_BETWEEN(SYSDATE, HIRE_DATE)), CASE
...
SELECT LOCATION_ID, COUNT(MANAGER_ID)
FROM DEPARTMENTS

...
SELECT D.DEPT_NO, D.DEPT_NAME, SUM(E.SALARY) AS TOTAL_SALARY
FROM DEPT_T D INNER JOIN EMP_T E
ON D.DEPT_NO = E.DEPART
GROUP BY D.DEPT_NO, D.DEPT_NAME;
    
SELECT D.DEPT_NO, D.DEPT_NAME, E.TOTAL_SALARY
FROM DEPT_T D INNER JOIN 
(SELECT DEPART, SUM(SALARY) AS TOTAL_SALARY
FROM EMP_T
GROUP BY DEPART) E
ON D.DEPT_NO = E.DEPART;
...
AS (SELECT DEPART, SUM(SALARY) AS TOTAL_SALARY
    FROM EMP_T
    GROUP BY DEPART)
SELECT D.DEPT_NO, D.DEPT_NAME, G.TOTAL_SALARY
